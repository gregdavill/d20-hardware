...
d20_lib = SchLib(tool=SKIDL).add_parts(*[
        ...
        Part(**{ 'name':'LTC4367', 'dest':TEMPLATE, 'tool':SKIDL, 'Manf':'Linear Technology/Analog Devices', 'PN':'LTC4367IDD#PBF', 'F0':'U', 'F1':'LTC4367', 'ref_prefix':'U', 'num_units':1, 'do_erc':True, 'footprint':'Package_DFN_QFN:DFN-8-1EP_3x3mm_P0.5mm_EP1.66x2.38mm', 'pins':[
        ...
        Part(**{ 'name':'AON7804', 'dest':TEMPLATE, 'tool':SKIDL, 'Manf':'Alpha / Omega Semiconductor Inc.', 'PN':'AON7804', 'F0':'U', 'F1':'AON7804', 'ref_prefix':'U', 'num_units':1, 'do_erc':True, 'footprint':'gkl_housings_dfn:DFN3X3_8L_EP2_P', 'pins':[
        ...
        Part(**{ 'name':'R', 'dest':TEMPLATE, 'tool':SKIDL, 'keywords':'R res resistor', 'Manf':'Yageo', 'PN':'RC0201FR-07510KL', 'F0':'R', 'datasheet':'~', 'description':'Resistor', 'F1':'R', 'ref_prefix':'R', 'num_units':1, 'fplist':['R_*'], 'do_erc':True, 'footprint':'Resistor_SMD:R_0201_0603Metric', 'pins':[
            Pin(num='1',name='~',func=Pin.types.PASSIVE,do_erc=True),
            Pin(num='2',name='~',func=Pin.types.PASSIVE,do_erc=True)] }),
        Part(**{ 'name':'TPS62135', 'dest':TEMPLATE, 'tool':SKIDL, 'Manf':'Texas Instruments', 'PN':'TPS621351RGXR', 'F0':'U', 'F1':'TPS62135', 'ref_prefix':'U', 'num_units':1, 'do_erc':True, 'footprint':'gkl_misc:VQFN-11_3x2mm_P0.5mm', 'pins':[
        ...
        Part(**{ 'name':'L', 'dest':TEMPLATE, 'tool':SKIDL, 'keywords':'inductor choke coil reactor magnetic', 'Manf':'Wurth Electronics Inc.', 'PN':'78438357010', 'F0':'L', 'datasheet':'~', 'description':'Inductor', 'F1':'L', 'ref_prefix':'L', 'num_units':1, 'fplist':['Choke_*', '*Coil*', 'Inductor_*', 'L_*'], 'do_erc':True, 'footprint':'Inductor_SMD:L_Coilcraft_XxL4020', 'pins':[
            Pin(num='1',name='1',func=Pin.types.PASSIVE,do_erc=True),
            Pin(num='2',name='2',func=Pin.types.PASSIVE,do_erc=True)] }),
        Part(**{ 'name':'C', 'dest':TEMPLATE, 'tool':SKIDL, 'keywords':'cap capacitor', 'Manf':'Murata Electronics', 'PN':'GRM188R61C106MAALD', 'F0':'C', 'datasheet':'~', 'description':'Unpolarized capacitor', 'F1':'C', 'ref_prefix':'C', 'num_units':1, 'fplist':['C_*'], 'do_erc':True, 'footprint':'Capacitor_SMD:C_0603_1608Metric', 'pins':[
            Pin(num='1',name='~',func=Pin.types.PASSIVE,do_erc=True),
            Pin(num='2',name='~',func=Pin.types.PASSIVE,do_erc=True)] }),
        Part(**{ 'name':'TPS561201', 'dest':TEMPLATE, 'tool':SKIDL, 'Manf':'Texas Instruments', 'PN':'TPS561201DDCT', 'F0':'U', 'F1':'TPS561201', 'ref_prefix':'U', 'num_units':1, 'do_erc':True, 'footprint':'Package_TO_SOT_SMD:TSOT-23-6', 'pins':[
        ...
        Part(**{ 'name':'NP115-2.5', 'dest':TEMPLATE, 'tool':SKIDL, 'Manf':'ON Semiconductor', 'PN':'NCP115CMX250TCG', 'F0':'U', 'F3':'http://www.onsemi.com/pub/Collateral/NCP167-D.PDF', 'F1':'NCP167', 'ref_prefix':'U', 'num_units':1, 'do_erc':True, 'footprint':'gkl_housings_son:X2SON_4_1.0x1.0mm', 'pins':[
        ...
        Part(**{ 'name':'NP115-1.2', 'dest':TEMPLATE, 'tool':SKIDL, 'Manf':'ON Semiconductor', 'PN':'NCP115AMX120TCG', 'F0':'U', 'F3':'http://www.onsemi.com/pub/Collateral/NCP167-D.PDF', 'F1':'NCP167', 'ref_prefix':'U', 'num_units':1, 'do_erc':True, 'footprint':'gkl_housings_son:X2SON_4_1.0x1.0mm', 'pins':[
            Pin(num='1',name='OUT',func=Pin.types.INPUT,do_erc=True),
            Pin(num='2',name='GND',func=Pin.types.INPUT,do_erc=True),
            Pin(num='3',name='EN',func=Pin.types.INPUT,do_erc=True),
            Pin(num='4',name='IN',func=Pin.types.INPUT,do_erc=True)] }),
        Part(**{ 'name':'Ferrite_Bead_Small', 'dest':TEMPLATE, 'tool':SKIDL, 'keywords':'L ferrite bead inductor filter', 'Manf':'Taiyo Yuden', 'PN':'BK0603HR601-T', 'F0':'FB', 'datasheet':'~', 'description':'Ferrite bead, small symbol', 'F1':'Ferrite_Bead_Small', 'ref_prefix':'FB', 'num_units':1, 'fplist':['Inductor_*', 'L_*', '*Ferrite*'], 'do_erc':True, 'footprint':'Inductor_SMD:L_0201_0603Metric', 'pins':[
            Pin(num='1',name='~',func=Pin.types.PASSIVE,do_erc=True),
            Pin(num='2',name='~',func=Pin.types.PASSIVE,do_erc=True)] }),
        Part(**{ 'name':'CP1', 'dest':TEMPLATE, 'tool':SKIDL, 'keywords':'cap capacitor', 'Manf':'Nichicon', 'PN':'UWX1C101MCL1GB', 'F0':'C', 'datasheet':'~', 'description':'Polarized capacitor, US symbol', 'F1':'CP1', 'ref_prefix':'C', 'num_units':1, 'fplist':['CP_*'], 'do_erc':True, 'footprint':'Capacitor_SMD:CP_Elec_5x3.9', 'pins':[
            Pin(num='1',name='~',func=Pin.types.PASSIVE,do_erc=True),
            Pin(num='2',name='~',func=Pin.types.PASSIVE,do_erc=True)] }),
        Part(**{ 'name':'LED_ARGB', 'dest':TEMPLATE, 'tool':SKIDL, 'keywords':'LED RGB diode', 'Manf':'Meihua', 'PN':'MHPA1515RGBDT', 'F0':'D', 'datasheet':'~', 'description':'RGB LED, anode/red/green/blue', 'F1':'LED_ARGB', 'ref_prefix':'D', 'num_units':1, 'fplist':['LED*', 'LED_SMD:*', 'LED_THT:*'], 'do_erc':True, 'footprint':'gkl_led:led_rbag_1515', 'pins':[
        ...
        Part(**{ 'name':'ATSAMD51G19A', 'dest':TEMPLATE, 'tool':SKIDL, 'Manf':'Microchip Technology', 'PN':'ATSAMD51G19A-MF', 'F0':'U', 'F1':'ATSAMD51G19A', 'ref_prefix':'U', 'num_units':1, 'do_erc':True, 'footprint':'Package_DFN_QFN:QFN-48-1EP_7x7mm_P0.5mm_EP5.15x5.15mm', 'pins':[
        ...
        Part(**{ 'name':'Crystal', 'dest':TEMPLATE, 'tool':SKIDL, 'keywords':'quartz ceramic resonator oscillator', 'Manf':'ECS Inc.', 'PN':'ECS-.327-9-12R-C-TR', 'F0':'Y', 'datasheet':'~', 'description':'Two pin crystal', 'F1':'Crystal', 'ref_prefix':'Y', 'num_units':1, 'fplist':['Crystal*'], 'do_erc':True, 'footprint':'Crystal:Crystal_SMD_2012-2Pin_2.0x1.2mm', 'pins':[
            Pin(num='1',name='1',func=Pin.types.PASSIVE,do_erc=True),
            Pin(num='2',name='2',func=Pin.types.PASSIVE,do_erc=True)] }),
        Part(**{ 'name':'ICE40UP5K-SG48ITR', 'dest':TEMPLATE, 'tool':SKIDL, 'keywords':'FPGA programmable logic', 'Manf':'Lattice Semiconductor Corporation', 'PN':'ICE40UP5K-SG48I', 'F0':'U', 'datasheet':'http://www.latticesemi.com/Products/FPGAandCPLD/iCE40Ultra', 'description':'iCE40 UltraPlus FPGA, 5280 LUTs, 1.2V, 48-pin QFN', 'F1':'ICE40UP5K-SG48ITR', 'F2':'Package_DFN_QFN:QFN-48-1EP_7x7mm_P0.5mm_EP5.6x5.6mm', 'ref_prefix':'U', 'num_units':4, 'fplist':['QFN*7x7mm*P0.5mm*EP5.6x5.6mm*'], 'do_erc':True, 'footprint':'Package_DFN_QFN:QFN-48-1EP_7x7mm_P0.5mm_EP5.15x5.15mm', 'pins':[
        ...
        Part(**{ 'name':'NC7WZ17', 'dest':TEMPLATE, 'tool':SKIDL, 'Manf':'ON Semiconductor', 'PN':'NC7WZ17FHX', 'F0':'U', 'F1':'NC7WZ17', 'ref_prefix':'U', 'num_units':1, 'do_erc':True, 'footprint':'gkl_misc:UDFN-6_1x1mm_P0.35mm', 'pins':[
        ...
        Part(**{ 'name':'Conn_02x05_Odd_Even', 'dest':TEMPLATE, 'tool':SKIDL, 'keywords':'connector', 'Manf':'Samtec Inc.', 'PN':'FTSH-105-01-F-DV-K-TR', 'F0':'J', 'datasheet':'~', 'description':'Generic connector, double row, 02x05, odd/even pin numbering scheme (row 1 odd numbers, row 2 even numbers), script generated (kicad-library-utils/schlib/autogen/connector/)', 'F1':'Conn_02x05_Odd_Even', 'ref_prefix':'J', 'num_units':1, 'fplist':['Connector*:*_2x??_*'], 'do_erc':True, 'footprint':'gkl_conn:FTSH-105-XX-X-DV', 'pins':[
            Pin(num='1',name='Pin_1',func=Pin.types.PASSIVE,do_erc=True),
        ...
        Part(**{ 'name':'BMX160', 'dest':TEMPLATE, 'tool':SKIDL, 'Manf':'Bosch Sensortec', 'PN':'BMX160', 'F0':'U', 'F1':'BMX160', 'ref_prefix':'U', 'num_units':1, 'do_erc':True, 'footprint':'Package_LGA:Bosch_LGA-14_3x2.5mm_P0.5mm', 'pins':[
        ...
        Part(**{ 'name':'AT25SF081', 'dest':TEMPLATE, 'tool':SKIDL, 'Manf':'Macronix', 'PN':'MX25R1635FZUIH0', 'F0':'U', 'F1':'AT25SF081', 'ref_prefix':'U', 'num_units':1, 'do_erc':True, 'footprint':'gkl_housings_dfn:DFN-8-1EP_3x2mm_Pitch0.5mm', 'pins':[
        ...
        Part(**{ 'name':'USB_C_Receptacle_USB2.0', 'dest':TEMPLATE, 'tool':SKIDL, 'keywords':'usb universal serial bus type-C USB2.0', 'Manf':'Hirose Electric Co Ltd', 'PN':'CX90M-16P', 'F0':'J', 'datasheet':'https://www.usb.org/sites/default/files/documents/usb_type-c.zip', 'description':'USB 2.0-only Type-C Receptacle connector', 'F1':'USB_C_Receptacle_USB2.0', 'ref_prefix':'J', 'num_units':1, 'fplist':['USB*C*Receptacle*'], 'do_erc':True, 'footprint':'Connector_USB:USB_C_Receptacle_Palconn_UTC16-G', 'pins':[
        ...
        Part(**{ 'name':'SW_Push', 'dest':TEMPLATE, 'tool':SKIDL, 'keywords':'switch normally-open pushbutton push-button', 'Manf':'Panasonic Electronic Components', 'PN':'EVQ-P42B3M', 'F0':'SW', 'datasheet':'~', 'description':'Push button switch, generic, two pins', 'F1':'SW_Push', 'ref_prefix':'SW', 'num_units':1, 'do_erc':True, 'footprint':'gkl_misc:EVQP4', 'pins':[
            Pin(num='1',name='1',func=Pin.types.PASSIVE,do_erc=True),
            Pin(num='2',name='2',func=Pin.types.PASSIVE,do_erc=True)] }),
        Part(**{ 'name':'LTC4413-2', 'dest':TEMPLATE, 'tool':SKIDL, 'Manf':'Linear Technology/Analog Devices', 'PN':'LTC4413EDD-1#PBF', 'F0':'U', 'F1':'LTC4413-2', 'ref_prefix':'U', 'num_units':1, 'do_erc':True, 'footprint':'Package_DFN_QFN:DFN-10-1EP_3x3mm_P0.5mm_EP1.65x2.38mm', 'pins':[
